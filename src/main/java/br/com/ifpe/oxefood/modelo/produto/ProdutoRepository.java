...
public interface ProdutoRepository extends JpaRepository<Produto, Long> {
    ...
    //Esses quatro metodos vão ser utilizados na tela a depender da combinação do que o usuario preenche
  ...
  //Exemplo de uma busca exata
   ...
   //ContainingIgnoreCase ignora caixa alta e caixa baixa
